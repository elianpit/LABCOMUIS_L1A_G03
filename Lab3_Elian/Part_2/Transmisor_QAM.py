...
# Title: Transmisor QAM
# Author: Elian
# Copyright: uis-e3t-ciee
# Description: transmisor QAM
...
from Modulador_QAM import Modulador_QAM  # grc-generated hier_block
...
class Transmisor_QAM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Transmisor QAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmisor QAM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Transmisor_QAM")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1000, A, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, A, 0, 0)
        self.Modulador_QAM_0 = Modulador_QAM(
            Ac=Ac,
        )
        self.Lab3_comu1_part1_0_0 = Lab3_comu1_part1(
            I_vect=1024,
        )

        self.top_layout.addWidget(self.Lab3_comu1_part1_0_0)
        ...
        # Connections
        ##################################################
        self.connect((self.Modulador_QAM_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Lab3_comu1_part1_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulador_QAM_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.Lab3_comu1_part1_0_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.Modulador_QAM_0, 1))
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Modulador_QAM_0.set_Ac(self.Ac)
...
def main(top_block_cls=Transmisor_QAM, options=None):
