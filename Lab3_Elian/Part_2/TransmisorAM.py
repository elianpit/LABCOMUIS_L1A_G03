...
from lab3_comu1_part2 import lab3_comu1_part2  # grc-generated hier_block
...
class TransmisorAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.lab3_comu1_part2_0 = lab3_comu1_part2(
            Ac=Ac,
            ka=ka,
        )
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.lab3_comu1_part2_0, 0))
        self.connect((self.lab3_comu1_part2_0, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.lab3_comu1_part2_0.set_ka(self.ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.lab3_comu1_part2_0.set_Ac(self.Ac)
