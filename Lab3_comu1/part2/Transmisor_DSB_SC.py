...
# Title: Transmisor_DSB_SC
# Author: elian
# Copyright: uis
# Description: transmisor de carrier suprimida
...
class Transmisor_DSB_SC(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Transmisor_DSB_SC", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmisor_DSB_SC")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Transmisor_DSB_SC")
        ...
        # Blocks
        ##################################################
        self._ka_range = Range(-2, 4, 100E-6, 1, 200)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.Envolvente_compleja_DSB_SC_0, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.Envolvente_compleja_DSB_SC_0.set_ka(self.ka)
...
def main(top_block_cls=Transmisor_DSB_SC, options=None):
