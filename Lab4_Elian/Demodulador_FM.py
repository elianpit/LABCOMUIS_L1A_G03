...
class Demodulador_FM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demoluador_FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demoluador_FM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Demodulador_FM")
        ...
        self.analog_fm_preemph_0 = analog.fm_preemph(fs=200e3, tau=75e-6, fh=-1.0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate/50, 100e3, 10e3, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Demodulador_FM, options=None):
