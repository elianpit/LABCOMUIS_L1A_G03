...
# Author: Elian
# Copyright: uis
# Description: modulacion en fase
...
class Modulacion_PM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 125e5
        self.fm = fm = 1e3
        self.Kp = Kp = 1
        self.GTX = GTX = 0
        self.FC = FC = 50e6
        ...
        self._Kp_win = RangeWidget(self._Kp_range, self.set_Kp, "ceficiente kp", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Kp_win)
        self._GTX_range = Range(0, 30, 1, 0, 200)
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia GTX", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Am_range = Range(0, 5, 1e-6, 1, 200)
        ...
        self._Ac_range = Range(0, 5, 1e-6, 1, 200)
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "Ampliud Carrier", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        # Connections
        ##################################################
        self.connect((self.Envolvente_compleja_PM_0, 0), (self.blocks_complex_to_mag_0, 0))
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.Lab3_comu1_part1_0, 0))
