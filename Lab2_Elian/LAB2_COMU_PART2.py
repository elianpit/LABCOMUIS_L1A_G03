...
# Title: Radio_USRP
# Author: elian calderon
# Description: configuracion radio usrp cmo transmisor
...
class LAB2_COMU_PART2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Radio_USRP")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Radio_USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB2_COMU_PART2")
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(50000000, 2.2*1000000000, 1000000, 50000000, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, 'Frencuencia portadora', "counter_slider", float)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, samp_rate/10, A, 0, 0)
...
def main(top_block_cls=LAB2_COMU_PART2, options=None):
